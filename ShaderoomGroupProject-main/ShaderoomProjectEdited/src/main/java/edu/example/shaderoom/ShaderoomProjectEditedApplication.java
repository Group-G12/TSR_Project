...
public class ShaderoomProjectEditedApplication {


public static void main(String[] args) throws IOException {
    //This line may be different based on what your project is named. Use the appropriate class name appears above
    ClassLoader loader = ShaderoomProjectEditedApplication.class.getClassLoader();
...
//connect to Firebase
    ...
    SpringApplication.run(ShaderoomProjectEditedApplication.class, args);
    }
